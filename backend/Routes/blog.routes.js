...
const express= require('express')
const blogRoute = express.Router();
const {createBlog,getBlogbyid,deleteBlog,updateBlog,getallBlog,getBlogBySearch}=require("../Controllers/blogController")
...
blogRoute.route("/search").get(getBlogBySearch) 
